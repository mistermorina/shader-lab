      ...
      <div style={{ padding: "12px 20px", borderBottom: `1px solid ${S.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8, background: S.panel }}>
        ...
        {images.length > 0 && (
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
            ...
            {tab === "batch" && batchQueue.some(q => q.status === "done") && (
                    ...
                    >
                      ...
                      <canvas
                        ...
                        style={{
                          ...
                          borderRight: compareMode ? "1px solid rgba(255,255,255,.2)" : "none",
                        }}
                      />
                      {compareMode && (
                        <>
                          <div style={{ position: "absolute", top: 0, bottom: 0, left: `${comparePos * 100}%`, width: 1, background: "#fff" }} />
                          <button
                            type="button"
